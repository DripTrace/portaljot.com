...
# /waitlist_api/waitlists/
@router.get(
    "", response=List[WaitlistEntryListSchema], auth=helpers.waitlist_api_auth_user_required
)
...
@router.post(
    ...
    auth=helpers.waitlist_api_auth_user_or_annon,
)
...
@router.get(
    ...
    auth=helpers.waitlist_api_auth_user_required,
)

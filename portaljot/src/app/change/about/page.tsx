			...
			<main className="container mx-auto flex justify-center items-center px-4 py-8">
				<div className="max-w-3xl text-center">
					...
					<p className="text-lg mb-4 text-[#e6e8f0]">
						EditEvo is a browser-based video editor designed to
						provide users with powerful editing capabilities
						directly within their web browser.
					</p>

					<p className="text-lg mb-6 text-[#e6e8f0]">
						The application is built using a combination of modern
						web technologies including fabric.js for handling canvas
						operations, Next.js - a React framework for building
						server-side rendered applications, Tailwind CSS for
						efficient and customizable styling, MobX for state
						management, and TypeScript for type safety and enhanced
						developer experience.
					</p>
					<p className="text-lg mb-6 text-[#e6e8f0]">
						EditEvo aims to offer an intuitive and user-friendly
						interface while providing advanced video editing
						features, enabling users to create professional-quality
						videos without the need for specialized software.
					</p>

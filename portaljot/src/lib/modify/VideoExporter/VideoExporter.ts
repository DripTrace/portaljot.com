...
// 					) {
// 						timestamp =
// 							chunk.timestamp + (prefixTs - range.start) * 1e6;
// 						this.encodingNums += 1;
// 					} else {
...
// 			for (const audioTrack of videoBox
...
// 							(chunk.timestamp + chunk.duration!) / 1e6 <=
// 								range.end
// 					)
// 					.map((chunk) =>

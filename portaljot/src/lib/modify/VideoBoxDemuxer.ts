...
const processBuffer = async (
	...
	mp4File.appendBuffer(arrayBuffer as MP4ArrayBuffer);
	mp4File.flush();
...
// 	const bufferWithFileStart = new ArrayBuffer(arrayBuffer.byteLength);
// 	new Uint8Array(bufferWithFileStart).set(new Uint8Array(arrayBuffer));
// 	(bufferWithFileStart as any).fileStart = 0;

// 	mp4File.appendBuffer(bufferWithFileStart as MP4ArrayBuffer);
// 	mp4File.flush();

...
export const tabsStyles = style({
	display: "flex",
	borderBottom: `1px solid ${tokens.colors["secondary-border"]}`,
});

export const tabStyles = style({
	padding: `${tokens.spacings["3"]} ${tokens.spacings["5"]}`,
	color: tokens.colors["white50"],
	cursor: "pointer",
	background: "none",
	border: "none",
...
export const activeTabStyles = style({
	color: tokens.colors["white100"],
	borderBottom: `2px solid ${tokens.colors["bright-blue"]}`,
});

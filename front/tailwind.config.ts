	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				artistc: "rgb(106,161,163)",
				enthusiastc: "rgb(186,102,149)",
				projectc: "rgb(100,126,186)",
				traderc: "rgb(164,108,192)",
				"dark-green": "#56783c",
				"lime-green": "#CFF073",
				"darklime-green": "#333726",
				"darker-white": "#cccccc",
				"dark-white": "#e6e6e6",
				"solid-white": "#ffffff",
				"semi-light-gray": "#333333",
				"transparent-gray": "#353538",
				"light-gray": "#B3B3B3",
				"dark-gray": "#999999",
				"darker-gray": "#808080",
				"darkest-gray": "#303034",
				"lighter-black": "#111115",
				"more-opaque-gray": "#0C161E",
				"opaque-gray": "#1C252D",
				"less-opaque-gray": "#1c252dff",
				"transparent-black": "#19191d",
				"light-black": "#232227",
				"dark-black": "#0B0A10",
				"darker-orange": "#a57131",
				"dark-orange": "#bc8808",
				"light-orange": "#b05321",
				"special-orange": "#ffa800",
				"redish-brown": "#6d4c4c",
				bgcolor: "#161716",
				ovteal: "#01CEC8",
				ovtealdull: "#16282D",
			...
			animation: {
				...
				ovationRotate:
					"ovation_Rotate breath 1.5s alternate ease-in-out infinite",

export class Item {
	...
	DOM = {
		...
		inner: null, // Reference to the inner DOM elements with class 'gtext-box-inner'.
		innerWrap: null, // Reference to the inner DOM element parent with class 'gtext-box'.
	};
	...
	layout() {
		...
		for (let i = 0; i < this.totalCells; ++i) {
			newHTML += `<span class="gtext-box"><span class="gtext-box-inner">${this.DOM.el.dataset.text}</span></span>`;
		}

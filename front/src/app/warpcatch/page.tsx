...
const features = [
	...
	},
	{
		...
		name: "Cloud Backup",
		description:
			"Rest assured knowing your documents are safely backed up on the cloud, protected from any loss or damage.",
		icon: ServerCogIcon,
	},
	{
		feature: 5,
...
export default function Home() {
	return (
		<div className="bg-gradient-to-bl from-white to-indigo-600 overflow-scroll p-2 lg:p-5 flex-1">
				...
				<div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
					<div className="mx-auto max-w-2xl sm:text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-600">
							...
							<br />
							<br /> Upload your document, and our chatbot will
							answer questions, summarize content, and andswe any
							questions you have about the document. This can be
							for anyone,{" "}

...
We update quickly, please star us on Github:  [github.com/DripTrace/nexusconjure](https://github.com/DripTrace/nexusconjure) ⭐
...
You can check out the detailed API documentation at [nexusconjure.com/music/docs](https://nexusconjure.com/music/docs).
...
- \`/music/api/get\`: Get music list
- \`/music/api/get?ids=\`: Get music Info by id, separate multiple id with ",".

...
import { getConnectAccountProducts } from "@/lib/nexusconjure/stripe/stripe-actions";

import FunnelForm from "@/components/nexusconjure/forms/funnel-form";
import {
	Card,
	CardContent,
	CardDescription,
		...
		<div className="flex gap-4 flex-col xl:!flex-row">
			<Card className="flex-1 flex-shrink">
				<CardHeader>
					...
					<CardDescription>
						Select the products and services you wish to sell on
						this funnel. You can sell one time and recurring
						products too.
					</CardDescription>
				</CardHeader>
				<CardContent>

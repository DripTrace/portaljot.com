"use client";
import CreateFunnelPage from "@/components/nexusconjure/forms/funnel-page";
...
import FunnelPagePlaceholder from "@/components/nexusconjure/icons/funnel-page-placeholder";
							...
							<CardHeader>
								...
								<CardDescription className="flex flex-col gap-4">
									<div className="border-2 rounded-lg sm:w-80 w-full  overflow-clip">
										<Link
											href={`/nexusconjure/subaccount/${subaccountId}/funnels/${funnelId}/editor/${clickedPage?.id}`}
										...
										<Link
											target="_blank"
											href={`${process.env.NEXT_PUBLIC_SCHEME}${funnel.subDomainName}.${process.env.NEXT_PUBLIC_DOMAIN_NEXUSCONJURE}/${clickedPage?.pathName}`}
										...
										>
											...
											<div className="w-64 overflow-hidden overflow-ellipsis ">
												...
												{
													process.env
														.NEXT_PUBLIC_DOMAIN_NEXUSCONJURE
												}

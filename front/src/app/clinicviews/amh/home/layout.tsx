import AccessMentalHealth from "@/components/clinicviews/Access-MentalHealth/AccessMentalHealth";
	...
	return (
		<html lang="en" className="no-js overflow-x-hidden">
			...
			<body className="demo-1 loading">
				...
				<Script src="/clinicviews/access-mentalhealth/js/gsap.min.js"></Script>
				<Script src="/clinicviews/access-mentalhealth/js/ScrollTrigger.min.js"></Script>
				<Script src="/clinicviews/access-mentalhealth/js/Flip.min.js"></Script>
				<Script src="/clinicviews/access-mentalhealth/js/imagesloaded.pkgd.min.js"></Script>
				<Script src="/clinicviews/access-mentalhealth/js/lenis.js"></Script>
				<Script src="/clinicviews/access-mentalhealth/js/smoothscroll.js"></Script>
				<Script
					type="module"
					src="/clinicviews/access-mentalhealth/js/index.js"
				></Script>
			</body>
		</html>
	);

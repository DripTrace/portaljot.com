...
export default function DebugPage() {
	...
	const pathname = headersList.get("x-invoke-path") || "/clinicviews/";
	...
	return (
		<main>
			...
			<div>
				...
				<Link href="/clinicviews/cached-on-nav" prefetch={false}>
					cache on nav
				</Link>
			</div>
			<div className="mt-2">
				...
				<Link href="/clinicviews/cache-on-demand">cache on demand</Link>
			</div>
		</main>
	);
}

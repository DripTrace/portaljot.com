...
self.addEventListener("message", async (event) => {
	if (event.data.action === "cache-on-demand") {
		const domainLogos = {
			llpmg: "clinicviews/images/llpmg_logo.png",
			fsclinicals: "clinicviews/images/fsclinicals_logo.png",
			amh: "clinicviews/images/amh_logo.png",
			driptrace: "clinicviews/images/driptrace_logo.png",
		};

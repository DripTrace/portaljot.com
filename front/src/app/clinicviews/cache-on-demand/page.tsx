...
declare global {
	interface Window {
		serwist: {
			messageSW: (params: { action: string }) => Promise<boolean>;
		};
	}
}
...
export default function Page() {
	...
	return (
		<div>
			...
			<p>
				Try clicking it, and then navigating to the image page when you
				are offline. The page is prefetched and the image is cached so

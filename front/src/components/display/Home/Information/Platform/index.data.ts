export const About = {
    ...
    imgStart: false,
    img: "assets/greenspot-hub-productions/LandingPageProps/PhotographyProps/optimize_image_green1.svg",
    // img: "",
    alt: "optimize",
    dark: true,
    primary: true,
...
export const Discover = {
    ...
    imgStart: true,
    img: "assets/greenspot-hub-productions/LandingPageProps/VideographyProps/media_player_green2.svg",
    alt: "player",
    dark: false,
    primary: false,
    darkText: true,
...
export const Access = {
    ...
    imgStart: false,
    img: "assets/greenspot-hub-productions/LandingPageProps/RecordingProps/compose_music_green3.svg",
    alt: "compose",
    dark: false,
    primary: false,
    darkText: true,

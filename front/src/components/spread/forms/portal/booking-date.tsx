...
import { APPOINTMENT_TIME_SLOTS } from "@/constants/spread/timeslots";
		...
		<div className="flex flex-col gap-5 justify-center">
			...
			<div className="flex gap-10 flex-col sm:flex-row">
				<div className="w-[300px]">
					...
					<CardDescription>
						During this call, we aim to explore potential avenues
						for partnership, promotional opportunities, or any other
						means through which we can contribute to the success of
						your company.
					</CardDescription>
				</div>
				<div>

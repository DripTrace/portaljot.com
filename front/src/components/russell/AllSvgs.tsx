...
export const PowerBtn: React.FC<SvgProps> = (props) => {
    return (
        <svg
            aria-hidden="true"
            data-prefix="fas"
...
export const YinYang: React.FC<SvgProps> = (props) => {
    return (
        <svg
            aria-hidden="true"
            data-prefix="fas"
...
export const Anchor: React.FC<SvgProps> = (props) => {
    return (
        <svg
            aria-hidden="true"
            data-prefix="fas"
...
export const Link: React.FC<SvgProps> = (props) => {
    return (
        <svg
            aria-hidden="true"
            data-prefix="fas"
...
export const Design: React.FC<SvgProps> = (props) => {
    return (
        <svg
            aria-hidden="true"
            data-prefix="fas"
...
export const Develope: React.FC<SvgProps> = (props) => {
    return (
        <svg
            aria-hidden="true"
            data-prefix="fas"

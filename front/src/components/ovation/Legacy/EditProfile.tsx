...
const ProfileEdit = ({
    ...
    return (
        <div className="flex w-full overflow-y-auto h-screen">
            <div className="w-full text-left p-4 flex-col">
                <form onSubmit={handleSubmit}>
                    <section className="p-4 h-full min-h-screen flex-col">
                        ...
                        <div className="mt-10 mx-auto">
                            ...
                            {/* Text Inputs */}
                            <label
                                className="w-3/4 block text-xl font-bold mb-2  mt-10"
                                htmlFor="category"
                            >
                                General Info
                            </label>
                            ...
                            <div className="mb-6">
                                <input
                                    ...
                                    } // update the location state variable
                                />
                            </div>
                            <div className="mb-6">
                                <label

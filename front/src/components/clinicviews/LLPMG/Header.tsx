...
const Header: React.FC = () => {
	...
	const navItems = [
		{ name: "Home", path: "/clinicivews/llpmg/landing" },
		{ name: "Why Choose Us", path: "/clinicivews/llpmg/why-choose-us" },
		{ name: "Locations", path: "/clinicivews/llpmg/locations" },
		{
			name: "Providers & Staff",
			path: "/clinicivews/llpmg/providers-and-staff",
		},
		{
			name: "Privacy & Notices",
			path: "/clinicivews/llpmg/privacy-and-notices",
		},
		{
			name: "BLOG",
	...
	return (
		...
		>
			<div className="container mx-auto px-4 py-4 flex justify-between items-center gap-5">
				<Link
					href="/clinicviews/llpmg/landing"
							...
							{isContactDropdownOpen && (
								<div className="bg-white dark:bg-gray-800 flex flex-col items-center justify-center">
									...
									<Link
										...
										onTouchEnd={() => {
											handleMobileLinkClick(
												"/clinicivews/llpmg/intake-packet"
											);
											dispatch(toggleMenu());
											setIsContactDropdownOpen(false);
										}}

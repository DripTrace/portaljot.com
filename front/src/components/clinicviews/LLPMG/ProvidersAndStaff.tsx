	...
	const staffMembers: StaffMember[] = [
		{
			...
			url: "/clinicviews/providers-and-staff/Mubashir_Farooqi.webp",
		...
		},
		{
			...
			url: "/clinicviews/providers-and-staff/Liberty_Olive_Macias.webp",
		...
		},
		{
			...
			url: "/clinicviews/providers-and-staff",
			name: "Uloma Anozie",
			title: "Psychiatric Nurse Practitioner",
			role: "provider",
			degree: "DNP",
		...
		// },
		{
			...
			url: "/clinicviews/providers-and-staff/Carolyn_Alexandar.webp",
		...
		{
			alt: "Don_Kreger_PhD",
			url: "/clinicviews/providers-and-staff/Don_Kreger.webp",
			name: "Don W. Kreger",
			title: "Psychologist",
			role: "provider",
			degree: "Ph.D",
		},
		{
			...
			url: "/clinicviews/providers-and-staff/Tatum_David.webp",
			name: "Tatum David",
			title: "Psychiatric Nurse Practitioner",
			role: "provider",
			degree: "PMHNP-BC",
		...
		// },
		{
			...
			url: "/clinicviews/providers-and-staff/Guy_Biakop.webp",
			name: "Guy Biakop",
			title: "Psychiatric Nurse Practitioner",
			role: "provider",
			degree: "PMHNP-BC",
		...
		// },
		{
			...
			url: "/clinicviews/providers-and-staff/Joytila_Singh.webp",
			name: "Joytila Singh",
			title: "Psychiatrist",
			role: "provider",
			degree: "M.D.",
		...
		},
		{
			...
			url: "/clinicivews/llpmg/providers/martin_calixterio.png",
		...
		// 	url: "/clinicviews/providers-and-staff/Charles_Nguyen.webp",
		// 	name: "Charles Nguyen",
		// 	title: "Psychiatrist",
		// 	role: "provider",
		// 	degree: "M.D.",
		...
		// },
		{
			...
			url: "/clinicviews/providers-and-staff/Marlene_Millan.webp",
			name: "Marlene Millan",
			title: "Psychiatric Nurse Practitioner",
			role: "provider",
			degree: "PMHNP-BC",
		...
		},
		{
			...
			url: "/clinicviews/providers-and-staff/Maria_Piedra.webp",
			name: "Maria Piedra",
			title: "Psychologist",
			role: "provider",
			degree: "PhD",
		...
		{
			alt: "Gina_Black",
			url: "/clinicviews/providers-and-staff/Gina_Black.webp",
			name: "Gina Black",
		...
		},
		{
			...
			url: "/clinicviews/providers-and-staff/Anwar_Farooqi.webp",
			name: "Anwar Farooqi",
	...
	return (
		<div className="relative overflow-x-hidden w-full">
			<div className="fixed top-0 left-0 w-full h-screen z-0">
				...
				>
					<source
						src="/clinicviews/background/videos/3511842-uhd_3840_2160_24fps.mp4"
						type="video/mp4"
					/>

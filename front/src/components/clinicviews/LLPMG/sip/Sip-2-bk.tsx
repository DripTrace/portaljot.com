...
// //         incomingCall: false,
// //         callerNumber: "",
// //         callState: "idle" as "idle" | "initiating" | "ringing" | "active",
// //     });
...
// //         socketRef.current.on("callInitiated", ({ callId }) => {
// //             console.log("[Sip] Call initiated with ID:", callId);
// //             setCallId(callId);
// //             setState((prevState) => ({
// //                 ...prevState,
// //                 callState: "initiating",
...
// //         socketRef.current.on("callRinging", () => {
// //             console.log("[Sip] Call is ringing");
// //             setState((prevState) => ({ ...prevState, callState: "ringing" }));
// //         });
...
// //         socketRef.current.on("audioData", (audioData: ArrayBuffer) => {
// //             console.log(`[Sip] Playing audio: ${audioData}`);
// //             playAudio(audioData);
// //         });
...
// //     const startAudioHandling = async () => {
// //         console.log("[SIP] Handling audio");
// //         try {
// //             console.log("[SIP] Retreiving user media");
// //             streamRef.current = await navigator.mediaDevices.getUserMedia({
// //                 audio: true,
// //             });
// //             audioContextRef.current = new (window.AudioContext ||
...
// //     const sendAudioToServer = async (audioData: ArrayBuffer) => {
// //         try {
// //             console.log("[SIP] Sending audio to server");
// //             await fetch("/api/llpmg/sip-handler", {
// //                 method: "PUT",
// //                 headers: {
// //                     "Content-Type": "application/octet-stream",
...
// //         console.log(`[Sip] Playing audio: ${audioData}`);
// //         if (!audioContextRef.current) {
// //             console.log("[Sip] Currently no audio data, setting reference");
// //             audioContextRef.current = new (window.AudioContext ||
// //                 (window as any).webkitAudioContext)();
// //         }

// //         try {
// //             console.log("[Sip] Setting audio buffer");
// //             const audioBuffer =
// //                 await audioContextRef.current.decodeAudioData(audioData);
// //             const sourceNode = audioContextRef.current.createBufferSource();
// //             sourceNode.buffer = audioBuffer;
...
// //     const stopAudioHandling = () => {
// //         console.log("[Sip] Stopping audio handling");
// //         if (streamRef.current) {
// //             streamRef.current.getTracks().forEach((track) => track.stop());
// //         }
// //         if (processorRef.current) {
...
// //     const handleAnswer = async () => {
// //         try {
// //             console.log("[Sip] Handling call answer");
// //             await fetch("/api/llpmg/sip-handler", {
// //                 method: "POST",
// //                 headers: {
// //                     "Content-Type": "application/json",
...
// //     const handleDecline = async () => {
// //         try {
// //             console.log("[Sip] Handling call decline");
// //             await fetch("/api/llpmg/sip-handler", {
// //                 method: "POST",
// //                 headers: {
// //                     "Content-Type": "application/json",
...
// //     useEffect(() => {
// //         console.log(`[Sip] Current call id: ${callId}`);
// //     }, [callId]);
...
// //         try {
// //             console.log(
// //                 "[SIP] Sending audio to server, size:",
...
//     const streamRef = useRef<MediaStream | null>(null);
//     const processorRef = useRef<ScriptProcessorNode | null>(null);
//     const isAudioHandlingActive = useRef<boolean>(false);
...
//     const startAudioHandling = async () => {
//         try {
//             if (isAudioHandlingActive.current) return; // Prevent multiple starts
...
//             processorRef.current.onaudioprocess = (e) => {
//                 if (!state.callActive) return; // Stop processing if call is no longer active
//                 const audioData = e.inputBuffer.getChannelData(0);
//                 sendAudioToServer(audioData.buffer);
//             };

//             isAudioHandlingActive.current = true;
//         } catch (error) {
//             console.error("Error setting up audio handling:", error);
//         }
//     };
...
//             audioContextRef.current.close();
//         }
//         isAudioHandlingActive.current = false;
//     };

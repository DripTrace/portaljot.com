const APQr = () => {
    return (
        <svg height="256" width="256" viewBox="0 0 25 25" role="img">
            <path
                fill="#FFFFFF"
                d="M0,0 h25v25H0z"

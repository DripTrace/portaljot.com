...
import { fsclinicalsToggleDarkMode } from "@/store/clinicviews/slices/fsclinicalsThemeSlice";
	...
	return (
		...
		>
			<div className="container mx-auto flex justify-between items-center gap-[2rem]">
				<Link
					href="/clinicviews/fsclinicals/fsclinicals-landing"
					className={`${
				...
				>
					<Image
						src="/clinicviews/fsclinicals/fsclinicals_-.svg"
				...
				<nav className="hidden md:block">
					<ul className="flex items-center justify-center space-x-[7rem]">
						<li>
							<Link
								href="/clinicviews/fsclinicals/fsclinicals-view/fsclinicals-form"
								className={`${
									isDarkMode
										? "text-[#1FABC7]"
										: "text-[#0C3C60]"
						...
						<li>
							<Link
								href="/clinicviews/fsclinicals/fsclinicals-view/fsclinicals-returning-form"
								className={`${
									isDarkMode
										? "text-[#1FABC7]"
										: "text-[#0C3C60]"
						...
						<li>
							<Link
								href="/clinicviews/fsclinicals/contact-us"
								className={`${
									isDarkMode
										? "text-[#1FABC7]"
										: "text-[#0C3C60]"
						...
						<li>
							<Link
								href="/clinicviews/fsclinicals/about"
								className={`${
									isDarkMode
										? "text-[#1FABC7]"
										: "text-[#0C3C60]"

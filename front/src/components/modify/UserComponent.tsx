...
import { useEffect, useState, ChangeEvent, FormEvent, type FC } from "react";
...
const UserComponent: FC = () => {
	...
	const handleShippingForm = async (e: FormEvent) => {
		...
		await fetch("/api/modify/update-shipping", {
			method: "PUT",
	...
	async function changePasswordHandler(passwordData: {
		...
		const response = await fetch("/api/modify/change-password", {
			method: "PATCH",

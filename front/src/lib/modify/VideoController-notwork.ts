...
// export interface CommonVideoState {
// 	playing?: boolean;
// 	videoFrames?: VideoFrame[] | null;
// 	// Add any other common properties here
// }

// interface VideoControllerState extends CommonVideoState {
// 	// Add any additional properties specific to VideoController
// }

// interface VideoControllerProps {
// 	onEmit: (state: Partial<CommonVideoState>) => void;
// }
...
// import { VideoTrackController } from "./VideoTrackController/VideoTrackController";
...
// 	private videoTrackController: VideoTrackController;
...
// 		this.videoTrackController = new VideoTrackController({ onEmit }); // Pass the onEmit function
// 	}

// 	setVideoBoxes = async (videoBoxes: VideoBox[]) => {
...
// 						console.log("Video box setting aborted");
// 					} else {
// 						console.error(
// 							"Error setting video box:",
// 							error.message
// 						);
// 					}
// 				} else {
// 					console.error("Unknown error setting video box");
// 				}
// 			}
// 		} else {
...
// 	private setVideoBox = async (videoBox: VideoBox, signal: AbortSignal) => {
// 		// ... existing code ...

// 		try {
// 			await this.videoTrackController.setVideoBox(videoBox);
// 		} catch (error: unknown) {
// 			if (error instanceof Error) {
// 				if (error.name !== "AbortError") {
// 					console.error(
// 						"Error in video track controller:",
// 						error.message
// 					);
// 				}
// 			} else {
// 				console.error("Unknown error in video track controller");
// 			}
// 			throw error; // Re-throw the error to be caught in setVideoBoxes
// 		}
...
// 			MAX_CAPACITY -
// 			(this.frameQueue.length + this.decodingVideoChunks.length);
...
// 			) {
// 				timestamp =
// 					chunk.timestamp + (prefixTimestamp - trackRangeStart) * 1e6;
// 			} else {
...
// 				decodeQueueHwm -
// 					(this.decodingAudioChunks.length +

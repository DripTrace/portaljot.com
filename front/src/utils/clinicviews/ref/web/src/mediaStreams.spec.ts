...
// // class MockSessionDescriptionHandler {
// //   public peerConnection = new MockPeerConnection();
// // }
...
// //   public userAgent = new MockUserAgent();
// //   public logger = new MockLogger();
// //   private eventEmitter = new EventEmitter();
...
// //   public getStats = jest.fn().mockResolvedValue(MockPeerConnection.defaultStats);
...
// //     Object.defineProperty(global.navigator, 'userAgent', {
// //       value: 'Firefox/5.0 (Windows; U; Win98; en-US; rv:0.9.2) Gecko/20010725',
// //       configurable: true,
// //     });
// //     expect(mediaStreamsImpl.browser()).toBe(Browsers.Firefox);

// //     Object.defineProperty(global.navigator, 'userAgent', {
// //       value: 'Safari/5.0 (Windows; U; Win98; en-US; rv:0.9.2) Gecko/20010725',
// //       configurable: true,
// //     });
// //     expect(mediaStreamsImpl.browser()).toBe(Browsers.Safari);

// //     Object.defineProperty(global.navigator, 'userAgent', {
// //       value: 'Opera/5.0 (Windows; U; Win98; en-US; rv:0.9.2) Gecko/20010725',
// //       configurable: true,
// //     });
// //     expect(mediaStreamsImpl.browser()).toBe(Browsers.Opera);

// //     Object.defineProperty(global.navigator, 'userAgent', {
// //       value: 'MSIE/5.0 (Windows; U; Win98; en-US; rv:0.9.2) Gecko/20010725',
// //       configurable: true,
// //     });
// //     expect(mediaStreamsImpl.browser()).toBe(Browsers.MSIE);
// //   });
...
// //     const mockReinvite = jest.fn().mockResolvedValue(null);
// //     mockSession.reinvite = mockReinvite;
// //     await mediaStreams.reconnectMedia();
// //     expect(mockReinvite).toBeCalled();
// //   });
...
// //       .mockResolvedValueOnce(firstStat)
// //       .mockResolvedValueOnce(secondStat);
// //     const getStatsCallback = jest.fn();
// //     mediaStreams.getMediaStats(getStatsCallback, 100);
// //     jest.advanceTimersByTime(200);
// //     await Promise.resolve();
...
//     public set iceConnectionState(state: string) {
//         this.connectionState = state;
//     }
...
//     public getStats(): Promise<any> {
//         return Promise.resolve(MockPeerConnection.defaultStats);
//     }

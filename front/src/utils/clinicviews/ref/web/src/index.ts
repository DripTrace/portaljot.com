...
export interface WebPhoneOptions {
	 ...
	 *
	 * [Reference](https://github.com/onsip/SIP.js/blob/master/docs/api/clinicviews/sip.js.useragentoptions.autostop.md)
	 *
	 * default value `true`
	 */
	autoStop?: boolean;
	...
	/** A function which will be called every time a log is generated. [Reference](https://github.com/onsip/SIP.js/blob/master/docs/api/clinicviews/sip.js.logconnector.md) */
	 ...
	 *
	 * [Reference](https://github.com/onsip/SIP.js/blob/master/docs/api/clinicviews/sip.js.sessiondescriptionhandlermodifier.md)
	 */
	 ...
	 *
	 * [Reference](https://github.com/onsip/SIP.js/blob/master/docs/api/clinicviews/sip.js.sessiondescriptionhandleroptions.md)
	 */
...
export default class WebPhone {
	...
	public constructor(
		...
		const appClientOs =
			uaMatch === null
				? ""
				: uaMatch[1].replace(/[^a-zA-Z0-9.:_]+/g, "-");

		const userAgentString =
			(this.appName
				? this.appName +
					(this.appVersion ? "/clinicviews/" + this.appVersion : "") +
					" "
				: "") +
		...
		sessionDescriptionHandlerFactoryOptions.enableDscp =
			!!options.enableDscp;

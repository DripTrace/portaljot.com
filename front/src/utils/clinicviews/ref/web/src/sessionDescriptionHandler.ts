    ...
    implements SessionDescriptionHandlerDefinition
{
    ...
    public set peerConnectionDelegate(
        delegate: PeerConnectionDelegate | undefined
    ) {
    ...
    public getDescription(
        ...
        return this.getLocalMediaStream(options)
            ...
            .then(() =>
                this.waitForIceGatheringComplete(iceRestart, iceTimeout)
            )
    ...
    public sendDtmf(
        ...
        this.logger.log(
            "SessionDescriptionHandler.sendDtmf sent via RTP: " +
                tones.toString()
        );
        return true;
    }
    ...
    protected getLocalMediaStream(
        ...
        return this.mediaStreamFactory(constraints, this as any).then(
    ...
    protected async enableSenderDscp() {
        ...
        for (const sender of this._peerConnection
            .getSenders()
                        ...
                        sender
                            ...
                            .then(() => {
                                const oldTrack = localStream
                                    .getTracks()
                                    .find(
                                        (localTrack) => localTrack.kind === kind
                                    );
                                if (oldTrack) {
                                    oldTrack.stop();
                    ...
                    this._peerConnection
                        ...
                        .forEach((transceiver) => {
                            if (
                                ...
                                const offerDirection = directionToOffer(
    ...
    protected waitForIceGatheringComplete(
        ...
        this.iceGatheringCompletePromise = new Promise<void>(
            (resolve, reject) => {
    ...
    private initPeerConnectionEventHandlers(): void {
        ...
        peerConnection.ontrack = (event): void => {
            ...
            this.logger.debug(
                `SessionDescriptionHandler.ontrack ${kind} ${enabled}`
            );

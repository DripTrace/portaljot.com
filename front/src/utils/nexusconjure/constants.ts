import BarChart from "@/components/nexusconjure/icons/bar_chart";
import Calendar from "@/components/nexusconjure/icons/calendar";
import CheckCircle from "@/components/nexusconjure/icons/check_circled";
import Chip from "@/components/nexusconjure/icons/chip";
import ClipboardIcon from "@/components/nexusconjure/icons/clipboardIcon";
import Compass from "@/components/nexusconjure/icons/compass";
import Database from "@/components/nexusconjure/icons/database";
import Flag from "@/components/nexusconjure/icons/flag";
import Headphone from "@/components/nexusconjure/icons/headphone";
import Home from "@/components/nexusconjure/icons/home";
import Info from "@/components/nexusconjure/icons/info";
import LinkIcon from "@/components/nexusconjure/icons/link";
import Lock from "@/components/nexusconjure/icons/lock";
import Message from "@/components/nexusconjure/icons/messages";
import Notification from "@/components/nexusconjure/icons/notification";
import Payment from "@/components/nexusconjure/icons/payment";
import Person from "@/components/nexusconjure/icons/person";
import Pipelines from "@/components/nexusconjure/icons/pipelines";
import NexusConjureCategory from "@/components/nexusconjure/icons/nexusconjure-category";
import Power from "@/components/nexusconjure/icons/power";
import Receipt from "@/components/nexusconjure/icons/receipt";
import Send from "@/components/nexusconjure/icons/send";
import Settings from "@/components/nexusconjure/icons/settings";
import Shield from "@/components/nexusconjure/icons/shield";
import Star from "@/components/nexusconjure/icons/star";
import Tune from "@/components/nexusconjure/icons/tune";
import Video from "@/components/nexusconjure/icons/video_recorder";
import Wallet from "@/components/nexusconjure/icons/wallet";
import Warning from "@/components/nexusconjure/icons/warning";
